            ...
            <div className="fixed inset-0 z-0 flex flex-col overflow-hidden font-['Outfit',sans-serif]">
                ...
                <div className="absolute top-4 right-4 md:top-6 md:right-6 z-50">
                    <button
                        ...
                        className="flex items-center gap-2 px-5 md:px-6 py-2 bg-red-500 hover:bg-red-600 text-white rounded-2xl font-black text-sm md:text-base border-[3px] border-black shadow-[0_4px_0_rgba(153,27,27,1)] hover:translate-y-[1px] hover:shadow-[0_2px_0_rgba(153,27,27,1)] active:translate-y-[4px] active:shadow-none whitespace-nowrap"
                    >
                        Close Session
                    </button>
                </div>
                ...
                <div className="relative z-10 w-full h-full flex flex-col items-center justify-center p-4 pt-20 md:p-8 lg:p-12 overflow-hidden">
                    {/* Card */}
                    <div className="w-full max-w-5xl h-full max-h-[750px] bg-white rounded-[32px] md:rounded-[40px] shadow-[0_12px_40px_rgba(0,0,0,0.12)] flex flex-col items-center relative border-[4px] md:border-[6px] border-transparent shrink-0 z-40 overflow-hidden">
